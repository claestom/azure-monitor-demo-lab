...
| `post-staged-deploy.ps1` | Discovers the staged App Service, AKS cluster, and central LAW, then runs the post-deployment, health model, and SLI setup used by `deploy.ps1`. | `./scripts/post-staged-deploy.ps1 -ResourceGroup <rg>` |
